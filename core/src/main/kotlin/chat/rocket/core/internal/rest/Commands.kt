...
suspend fun RocketChatClient.commands(offset: Int = 0, count: Int = 0): PagedResult<List<Command>> = withContext(Dispatchers.Default) {
...
suspend fun RocketChatClient.runCommand(command: Command, roomId: String): Boolean = withContext(Dispatchers.Default) {
