...
suspend fun RocketChatClient.registerPushToken(token: String) = withContext(Dispatchers.Default) {
...
suspend fun RocketChatClient.unregisterPushToken(token: String) = withContext(Dispatchers.Default) {
